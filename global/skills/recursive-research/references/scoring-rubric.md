...
Defines the metrics, weights, and ratchet thresholds used to decide whether to commit each iteration.
...
| Synthesis Clarity | 15% | Self-assessed on 1-10 scale during synthesis, normalized |
...
Do NOT commit if composite score decreased (regression). Log a warning.
...
## Synthesis Clarity Rubric (self-assessment)
...
Target score before committing synthesis: >= 7.
